      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-8 pt-12 lg:pt-0">
        ...
        >
          <div class="">
            <div class="flex items-center justify-center gap-4 m-2">
              ...
              >
                <p class="sm:block">Alain Lobato</p>
                <span class="text-zinc-500 md:block">Bs in Computer Science</span>
        ...
        <div class="mt-16 lg:mt-24 xl:mt-0 lg:col-span-5">
          ...
          <div class="p-3 items-center mt-12 flex justify-center space-x-3 flex-wrap">
            ...
            <MainIcon iconName="Database" />
            <MainIcon iconName="Docker" />
            <MainIcon iconName="Arduino" />
            <MainIcon iconName="Git" />
            <MainIcon iconName="Linux" />
          </div>
        </div>
      </div>
    </div>
