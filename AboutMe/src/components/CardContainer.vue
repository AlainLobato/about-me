    ...
    <div class="flex rounded-xl">
        <div class="max-w-105 mx-auto">
            <div class="relative flex w-full flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                ...
                <div  v-if="repositoryUrl" class="absolute right-0 flex bg-white/80 backdrop-blur-md rounded-full shadow-md shadow-blue-gray-500/20 justify-center items-center hover:scale-105 transition-transform hover:cursor-pointer">
                ...
                <div class="p-6">
                    ...
                    <p class="block font-sans text-base antialiased font-light leading-relaxed text-gray-700 h-35 min-h-35 overflow-scroll">
                        {{ description }}
                    </p>
                ...
                <div class="p-6 pt-3">
                    <a :href="websiteUrl" target="_blank">
                        <button
                            :class="{block: true, 'w-full select-none rounded-lg bg-gray-900 py-3.5 px-7 text-center align-middle font-sans text-sm font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 hover:bg-gray-800 hover:cursor-pointer': true,
