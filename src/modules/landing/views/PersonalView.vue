<template>
  <section class="mx-auto px-4 py-12 bg-surface flex flex-col w-screen gap-4 pt-8 items-center">
    <HeaderContainer
...
import { personalActivities } from '@/constants/personalActivities'
</script>
