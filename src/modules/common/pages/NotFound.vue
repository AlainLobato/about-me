...
<template>
  ...
  >
    ...
    >
      <p class="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-orange-300">404</p>
      <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-orange-300 mt-2">
        Page Not Found
      </p>
      <p class="text-lg md:text-xl lg:text-2xl text-orange-500 my-12">
        Sorry, the page you are looking for could not be found.
      </p>
      <RouterLink
        replace
        to="/"
        class="flex items-center space-x-2 bg-orange-600 hover:bg-orange-700 text-gray-100 px-4 py-2 rounded transition duration-150"
        title="Return Home"
      >
        <svg
